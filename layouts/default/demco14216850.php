        ...
        $lay->container('Lines');
          $lay->container('Columns');
            ...
            while ($row = $rpt->each()) {
              ...
              $lay->container('Lines', ['height'=>'51.0mm', 'width'=>'97.0mm']);
                $lay->container('Columns');
		  // Label 1 (spine):
                  $lay->container('Column', ['x-align'=>'center', 'y-align'=>'center', 'width'=>'22.5mm', 'height'=>'37.5mm', 'margin-left'=>'3mm']);
		  ...
		  $lay->close();
		  // Label 3:
		  $lay->container('Column', ['width'=>'70.5mm', 'height'=>'25.4mm', 'margin-top'=>'2.5mm', 'margin-bottom'=>'2.5mm', 'margin-left'=>'2.5mm', 'margin-right'=>'2.5mm', 'y-align'=>'center']);
		    $lay->pushFont('Helvetica', 9);
                    					$lay->container('TextLine');
